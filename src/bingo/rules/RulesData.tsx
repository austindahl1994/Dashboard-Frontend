export const rulesHeaders: string[] = [
  "No Cheating",
  "Respectful Conduct",
  "Complaints and Conduct Related to the Event",
  "Dink Setup Requirement",
...
export const rulesData: string[] = [
  "Any form of cheating is strictly prohibited. This includes, but is not limited to, falsifying screenshots, using bots, utilizing external services, or engaging in any behavior intended to gain an unfair advantage.",
  "All participants must treat others with respect, including members of opposing teams. Lighthearted banter is acceptable; however, harassment, personal attacks, or behavior that crosses reasonable boundaries will not be tolerated.",
